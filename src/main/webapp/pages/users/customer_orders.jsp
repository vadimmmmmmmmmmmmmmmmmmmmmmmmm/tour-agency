...
<body class="vw-100 vh-100 mw-100 bg-transparent p-3">
    <cstm:navBar/>
    <section id="customers-orders" class="w-100">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <span class="card-text fw-bold">
                                            <fmt:message key="users.label.booked_by"/>
                                        </span>
                            ...
                            <div class="form-group w-100">
                                <form method="post">
                                    ...
                                    <input type="hidden" name="order_state" value="paid"/>
                                    <input type="hidden" name="command" value="change_order_state"/>
                                    <input class="btn btn-primary border-0 rounded-0 w-100" type="submit" value="confirm payment"/>
                                </form>
                            </div>
                            <div class="form-group w-100">
                                    <form method="post">
                                        <input type="hidden" name="order_id" value="${order.id}"/>
                                        <input type="hidden" name="order_state" value="cancelled"/>
                                        <input type="hidden" name="command" value="change_order_state"/>
                                        <input class="btn btn-danger border-0 rounded-0 w-100" type="submit" value="reject order"/>
                                    </form>
                                </div>
                            </div>
                        </div>
