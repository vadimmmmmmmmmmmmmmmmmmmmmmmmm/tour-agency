...
<body class="vw-100 vh-100 bg-transparent mh-100 mw-100 p-3">
<cstm:navBar/>
            ...
            <div class="w-100">
                <div class="d-flex flex-wrap justify-content-start mb-2 gap-2">
                    <c:forEach items="${requestScope.tour_list}" var="tour">
                        <div class="card bg-white border-0 rounded-0 shadow-sm" style="min-width:280px; max-width:280px;">
                            ...
                            <div class="card-body">
                                <a href="/tour-agency/catalog/tour?id=${tour.id}" class="card-title h5 fw-bold btn btn-link text-decoration-none link-dark p-0" style="text-transform: uppercase">
                                        ${tour.title}
                                </a>
