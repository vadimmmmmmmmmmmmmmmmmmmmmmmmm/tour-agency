...
<section id="tourInfo" class="position-relative d-flex flex-wrap gap-2 justify-content-start align-items-stretch w-100">
            ...
            <form method="post">
                <div class="container-fluid bg-light rounded-0 p-3 mb-1">
                    <div class="row">
                        <div class="col">
                                    <span>
                                        <fmt:message key="catalog.tour.label.tour_title"/>&nbsp;
                                    </span>
                ...
                <div class="container-fluid bg-light rounded-0 p-3 mb-1">
                    <div class="row">
                        <div class="col">
                                    <span>
                                        <fmt:message key="catalog.tour.label.tour_description"/>&nbsp;
                                    </span>
                            <input class="form-control" type="text" name="new_description"/>
                        </div>
                    </div>
                </div>
                ...
                <input type="hidden" name="tour_id" value="${tour.id}"/>
                <c:choose>
                    <c:when test="${supportedLanguages.containsKey('en')}">
                        <input type="hidden" name="command" value="change_tour_localisation_text">
                    </c:when>
                    <c:otherwise>
                        <input type="hidden" name="command" value="add_tour_localisation_text">
                    </c:otherwise>
                </c:choose>
                <input class="btn btn-primary border-0 rounded-0" type="submit" value="<fmt:message key="catalog.label.apply"/>">
            </form>
        </div>
    </div>
    <div class="card w-auto bg-white border-0 rounded-0 shadow-sm" style="max-width: 380px;">
        <div class="card-body">
            ...
            <form method="post">
                ...
                <input type="hidden" name="tour_id" value="${tour.id}"/>
                <c:choose>
                    <c:when test="${supportedLanguages.containsKey('ua')}">
                        <input type="hidden" name="command" value="change_tour_localisation_text">
                    </c:when>
                    <c:otherwise>
                        <input type="hidden" name="command" value="add_tour_localisation_text">
    ...
    <div class="card w-auto bg-white border-0 rounded-0 shadow-sm" style="max-width: 380px;">
        <div class="card-body">
            ...
            <form method="post">
                ...
                <input type="hidden" name="tour_id" value="${tour.id}"/>
                <c:choose>
                    <c:when test="${supportedLanguages.containsKey('ru')}">
                        <input type="hidden" name="command" value="change_tour_localisation_text">
                    </c:when>
                    <c:otherwise>
                        <input type="hidden" name="command" value="add_tour_localisation_text">
    ...
    <div class="card w-auto bg-white border-0 rounded-0 shadow-sm mb-2" style="max-width: 380px;">
        <div class="card-body">
    ...
    <div class="card w-100 bg-white border-0 rounded-0 shadow-sm flex-sm-grow-1">
        <div class="card-body">
            <form method="post">
                ...
                <input class="btn btn-warning w-100 rounded-0 border-0" type="submit" value="<fmt:message key="catalog.tour.edit.label.delete_tour"/>">
            </form>
        </div>
    </div>
</section>
